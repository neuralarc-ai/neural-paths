    ...
    <section className="w-full py-20 px-4 lg:px-20">
      <div className="max-w-[1720px] mx-auto flex flex-col lg:flex-row items-center justify-between min-h-[520px]">
        ...
        <div className="flex-1 flex flex-col items-start justify-center max-w-2xl w-full mb-12 lg:mb-0">
          ...
          <button className="bg-[#2F2C28] cursor-pointer text-white text-lg shadow-[0_5px_0_0_#C6AEA3] hover:shadow-[0_3px_0_0_#C6AEA3] font-semibold rounded-full px-8 py-4 flex items-center gap-3 hover:bg-[#333] transition-all duration-300 ease-in-out">
            Explore Now
