...
const Footer = () => {
  return (
    <footer className="shadow-[0_-8px_0_0_#757372] bg-[#1E1E1E] rounded-t-2xl z-50">
      <div className="lg:h-[264px] max-w-[1920px] bg-[#1E1E1E] flex flex-col justify-between mx-auto w-full text-white lg:py-10 py-5 lg:px-10 px-4 z-50">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-0 bg-[#1E1E1E]">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-16 flex-1 justify-end">
            <Link
              href="https://neuralarc.ai"
              className="text-lg hover:underline"
            >
              Neural Path AI Suite
            </Link>
